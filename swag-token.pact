...
(module swag-token GOV
  ...
  @doc "The swag token is used for great things, such as teaching about how to \
  \ build your own token, initialize tokenomics, and secure your contract with \
  \ proper governance."
...
(if (read-msg "upgrade")
  ...
  [
    ...
    ;; 4. Initialize your token from "init-data"
